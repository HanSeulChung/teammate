    ...
    const fetchComments = async () => {
      try {
        const response = await axiosInstance.get<{ content: CommentType[] }>(
          `http://www.teammate.digital:8080team/${teamId}/documents/${documentsId}/comments`,
        );
    ...
    if (editingComment.trim() && editingIndex !== null) {
      ...
      try {
        const response = await axiosInstance.put(
          `http://www.teammate.digital:8080team/${teamId}/documents/${documentsId}/comments/${commentToUpdate.id}`,
    ...
    if (confirmDelete) {
      try {
        await axiosInstance.delete(
          `http://www.teammate.digital:8080team/${teamId}/documents/${documentsId}/comments/${commentId}`,
        );
  ...
  const getTeamParticipantNickname = async (
    ...
    try {
      const response = await axiosInstance.get(
        `http://www.teammate.digital:8080team/${teamId}/participant/list`,
      );
